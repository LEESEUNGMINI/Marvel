...
import Snapcha from "../assets/Snapcha";
    ...
    <div className="bg-[#151515] w-full flex justify-center py-16">
      <div className="max-w-7xl w-full flex justify-between text-white">
        ...
        <div className=" space-y-8">
          ...
          <div className="flex space-x-4">
            ...
            <div className="text-white">
              <h2 className="uppercase font-semibold ml-3">marvel insider</h2>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-4 gird-rows-2 gap-x-10 gap-y-6">
            <p>
              <Facebook />
            </p>
            <p>
